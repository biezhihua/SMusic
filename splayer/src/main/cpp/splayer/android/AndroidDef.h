...
//   'ext1' should be a value from the enum MediaErrorType.
...
//   'ext1' should be a value from the enum MediaInfoType.
...
//typedef struct MediaCodecInfoContext {
