...
public:
    ...
    static const int MSG_EVENT_CREATE_FAILURE = 36;
    static const int MSG_SURFACE_CREATE_FAILURE = 37;
    static const int MSG_AUDIO_CREATE_FAILURE = 38;
    static const int MSG_STREAM_CREATE_FAILURE = 39;
    static const int MSG_DISABLE_ALL_STREAM = 40;
