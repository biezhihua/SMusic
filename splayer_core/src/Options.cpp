...
void Options::showOptions() {
    ...
    ALOGD(OPTIONS_TAG, "%-*s: %d", VERSION_MODULE_FILE_NAME_LENGTH, "generateMissingPts", generateMissingPts);
    ALOGD(OPTIONS_TAG, "%-*s: %d", VERSION_MODULE_FILE_NAME_LENGTH, "lowResolution", lowResolution);
    ...
    ALOGD(OPTIONS_TAG, "%-*s: %d", VERSION_MODULE_FILE_NAME_LENGTH, "loopTimes", loopTimes);
    ...
    ALOGD(OPTIONS_TAG, "%-*s: %d", VERSION_MODULE_FILE_NAME_LENGTH, "findStreamInfoFillMissingInformation", findStreamInfoFillMissingInformation);
