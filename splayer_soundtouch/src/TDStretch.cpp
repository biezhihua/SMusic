...
// Quick _seek algorithm for improved runtime-performance: First roughly scans through the
...
// - this quick _seek algorithm finds the best match on ~90% of cases
...
#define SCANWIND    8
    ...
    for (i = SCANSTEP; i < seekLength - SCANWIND - 1; i += SCANSTEP)
    {
        ...
        // heuristic rule to slightly favour values close to mid of the _seek range
...
void TDStretch::calcSeqParameters()
{
    ...
    // _seek-window-ms setting values at above low & top tempoq
