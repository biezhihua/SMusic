...
#define FFMPEG_CONFIGURATION "--arch=x86_64 --cpu=x86_64 --prefix=/Users/biezhihua/StudySpace/FFmpegBuildTool/macos/tools/build/ffmpeg-x86_64/output --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.14.sdk --cc=clang --as=/Applications/Xcode.app/Contents/Developer/usr/bin/gcc --strip= --host-cflags= --host-ldflags= --enable-cross-compile --target-os=darwin --disable-stripping --enable-optimizations --disable-debug --enable-small --enable-gpl --enable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --enable-shared --disable-static --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --disable-postproc --disable-avresample --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --enable-avfilter --enable-network --disable-encoders --disable-hwaccels --disable-muxers --disable-devices --enable-protocol=async --disable-iconv --disable-dxva2 --disable-vaapi --disable-vdpau --disable-linux-perf --extra-cflags= --extra-ldflags=' -L/usr/local/lib -Wl,-no_compact_unwind'"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2019
#define FFMPEG_DATADIR "/Users/biezhihua/StudySpace/FFmpegBuildTool/macos/tools/build/ffmpeg-x86_64/output/share/ffmpeg"
#define AVCONV_DATADIR "/Users/biezhihua/StudySpace/FFmpegBuildTool/macos/tools/build/ffmpeg-x86_64/output/share/ffmpeg"
